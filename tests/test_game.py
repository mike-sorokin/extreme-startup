...
def test_players_with_more_than_fifteen_incorect_gets_added_to_assistance_list(basic_game_with_five_players):
...
def test_player_who_gets_one_correct_after_requiring_assistance_no_longer_needs_help(basic_game_with_five_players):
    game, players, players_dict = basic_game_with_five_players
    game._Game__update_players_to_assist(players_dict)
